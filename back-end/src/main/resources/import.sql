insert into user (id,full_name,password,role,username) values(1,'alain','1234','USER','al@mail.fr');
insert into user (id,full_name,password,role,username) values(2,'jerome','1234','USER','jl@mail.fr');
